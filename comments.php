...
<div id="comments">
    ...
    <h3 class="comments-title"><?php comments_number('0','1','%'); echo __(' responses on "','vibe'); echo vibe_sanitizer($post->post_title,'text').'"'; ?></h3>
...
comment_form(array('fields'=>apply_filters('comment_form_default_fields',$fields),'comment_field'=>$comment_field,'title_reply'=> '<span>'.__('Leave a Message','vibe').'</span>'));
                ?>
</div>
<?php
endif;
