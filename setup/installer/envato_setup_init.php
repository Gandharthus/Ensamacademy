				...
				public function theme_setup_wizard_content($content){
					if($this->is_possible_upgrade()){
						array_unshift_assoc($content,'upgrade',array(
							'title' => __( 'Upgrade', 'vibe' ),
							'description' => __( 'Upgrade Content and Settings', 'vibe' ),
							'pending' => __( 'Pending.', 'vibe' ),
							'installing' => __( 'Installing Updates.', 'vibe' ),
							'success' => __( 'Success.', 'vibe' ),
