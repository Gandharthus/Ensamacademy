    ...
    <div class="<?php echo vibe_get_container(); ?>">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3">
                <div class="quiz_next">
        <?php
            if(is_user_logged_in() && (!function_exists('is_wplms_4_0') || (function_exists('is_wplms_4_0') && is_wplms_4_0()) )){
                ...
                if(!$react_quizzes){
                    ...
                    if(function_exists('is_wplms_4_0') && is_wplms_4_0()){
                        echo apply_filters('wplms_start_quiz_button','<a class="button start_quiz_button create-group-button logintrigger full"> '.__('Login to Start the Quiz','vibe').'</a>',get_the_ID());
