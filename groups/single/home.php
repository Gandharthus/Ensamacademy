...
if($group_layout == 'blank'){
	vibe_include_template("group/$group_layout.php");  
}else{

if ( bp_has_groups() ) : while ( bp_groups() ) : bp_the_group();

vibe_include_template("group/top$group_layout.php");  
?>
...
vibe_include_template("group/bottom$group_layout.php","groups/bottom.php"); 
} 			
