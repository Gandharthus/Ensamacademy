					...
					<div id="content" class='evo_location_card evo_organizer_card'>
						<div class="hentry">
							<div class='eventon entry-content'>
								<div class="evo_location_tax" style='background-image:url(<?php echo vibe_sanitizer($img_url,'url');?>)'>
									<?php if($img_url):?><div class="location_circle" style='background-image:url(<?php echo vibe_sanitizer($img_url,'url');?>)'></div><?php endif;?>
									<h2 class="organizer_name"><span><?php echo vibe_sanitizer($organizer_link_a.$term->name.$organizer_link_b);?></span></h2>
									<div class='organizer_description'><?php echo category_description();?><p class='contactinfo'><?php echo vibe_sanitizer($term_meta['evcal_org_contact']);?></p>
										<?php
