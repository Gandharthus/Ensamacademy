	...
	<?php
		if(!$pmpro_confirm)
		{
			...
			<div class="pmpro_actionlinks">
				<a class="pmpro_btn pmpro_yeslink yeslink button" href="<?php echo pmpro_url("cancel", "?levelstocancel=" . esc_attr($_REQUEST['levelstocancel']) . "&confirm=true")?>"><?php _e('Yes, cancel this membership', 'paid-memberships-pro' );?></a>
				<a class="pmpro_btn pmpro_btn-cancel pmpro_nolink nolink button" href="<?php echo pmpro_url("account")?>"><?php _e('No, keep this membership', 'paid-memberships-pro' );?></a>
			</div>
			<?php
			}
			else
			{
				if($current_user->membership_level->ID)
				{
							...
							<?php
								...
								<tr>
									...
									<td class="pmpro_cancel-membership-cancel">
										<a class="button" href="<?php echo pmpro_url("cancel", "?levelstocancel=" . $level->id)?>"><?php _e("Cancel", 'paid-memberships-pro' );?></a>
									</td>
								</tr>
								<?php
								}
					...
					<div class="pmpro_actionlinks">
						<a class="button" href="<?php echo pmpro_url("cancel", "?levelstocancel=all"); ?>"><?php _e("Cancel All Memberships", 'paid-memberships-pro' );?></a>
					</div>
					<?php
				}
			}
		...
		{
			?>
			<p><a class="button" href="<?php echo get_home_url()?>"><?php _e('Click here to go to the home page.', 'paid-memberships-pro' );?></a></p>
			<?php
		}
	?>
