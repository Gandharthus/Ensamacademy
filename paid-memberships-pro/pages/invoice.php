...
<?php
	if($pmpro_invoice)
	{
		...
		<ul>
			...
			<li><strong><?php _e('Account', 'paid-memberships-pro' );?>:</strong> <?php echo vibe_sanitizer($pmpro_invoice->user->display_name)?> (<?php echo vibe_sanitizer($pmpro_invoice->user->user_email)?>)</li>
			<li><strong><?php _e('Membership Level', 'paid-memberships-pro' );?>:</strong> <?php echo vibe_sanitizer($pmpro_invoice->membership_level->name)?></li>
