...
class vibe_notes_discussions{
    ...
    // Comment Loop
          if ( $comments ) {
            ...
            foreach ( $comments as $comment ) {
              ?>
              <li class="loaded <?php echo vibe_sanitizer($comment->comment_type.' '.(($comment->comment_parent)?'parent':'')); ?>"><div class="<?php echo vibe_sanitizer($comment->comment_type); ?>" data-id="<?php echo vibe_sanitizer($comment->comment_ID,'text'); ?>">
                <?php
                ...
                ?>
                <div class="unit_comment_content"><?php echo vibe_sanitizer($comment->comment_content); ?></div>
                <?php 
    ...
    // Comment Loop 
          ...
          if ( $comments ) {
            ...
            foreach ( $comments as $comment ) {   //print_r($comment);
              ...
              ?>
              <li class="loaded <?php echo vibe_sanitizer($comment->comment_type.' '.(($comment->comment_parent)?'parent':'')); ?>"><div class="note" data-id="<?php echo vibe_sanitizer($comment->comment_ID,'text'); ?>">
                ...
                <div class="unit_comment_content">
                  ...
                  <div class="note_content"><?php echo vibe_sanitizer($comment->comment_content); ?></div>
                </div>
  ...
  function wplms_post_unit_comment(){
    ...
    if(is_numeric($comment_id)){
      ...
      echo vibe_sanitizer($comment_id);
  ...
  function wplms_get_user_reply(){
    ...
    ?>
      <li class="loaded <?php echo vibe_sanitizer($comment->comment_type.' '.(($comment->comment_parent)?'parent':'')); ?>">
      <div class="<?php echo vibe_sanitizer($comment->comment_type,'text'); ?>" data-id="<?php echo vibe_sanitizer($comment->comment_ID,'text'); ?>">
        <?php
        $author_id = $comment->user_id;
        $current_user_id = get_current_user_id();
